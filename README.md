...
```
The GUI now defaults to a dark theme for improved readability and no longer includes the rule editor pane. Use the **OAuth Login** button to authorize GitHub access.
