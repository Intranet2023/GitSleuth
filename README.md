...
When prompted, provide a domain name to narrow search results. CLI options allow setting, deleting and viewing tokens, running search groups, performing custom searches and adjusting settings.
